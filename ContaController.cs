...
namespace BankModelTransfer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Rafael agradece por utilizar os serviços");
            Console.ReadLine();
        }
        ...
        private static void ConsultarSaldo()
        {
            ...
            listContas[indiceConta].ConsultarSaldo();
        }
        ...
        private static void InserirConta()
        {
            ...
            Console.Write("Digite 1 para Conta Juridica ou 2 para Fisica: ");
            int entradaTipoConta = int.Parse(Console.ReadLine());

            if (entradaTipoConta == 1)
            {
                Console.Write("Digite o seu CNPJ: ");
                var entradaCNPJ = (Console.ReadLine());               
            }
            else
            {
                Console.Write("Digite o seu CPF: ");
                var entradaCPF = Console.ReadLine();
            }
